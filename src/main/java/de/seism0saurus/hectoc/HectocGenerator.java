...
public class HectocGenerator {
    ...
    // See https://wir-rechnen.de/hectoc/hectocs-ungeloest-unsolved for the current list of unsolvable Hectocs
    protected static final List<HectocChallenge> UNSOLVABLE_HECTOCS = List.of(
