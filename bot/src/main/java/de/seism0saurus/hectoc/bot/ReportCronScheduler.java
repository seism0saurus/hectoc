 ...
 */
@Service
@Profile("reports & cron-scheduling")
public class ReportCronScheduler {
     ...
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ReportCronScheduler.class);
     ...
     */
    public ReportCronScheduler(@Autowired ReportService service) {
